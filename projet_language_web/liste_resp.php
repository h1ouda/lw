<?php 
   ...
   ?>
   <?php 
       $pdostat=$base->prepare('SELECT login,role FROM utilisateur ');
       //execution requete
          ...
          <center>
                <div class="col-md-10 content">
                    <div class="panel panel-default" style="background-color: rgba(255, 255, 255, .3); width:40% ; margin-right:8%"> <!--couleur de la liste des problémes-->
                            ...
                            <h3 style="font-size:20px; font-family:'Gothic A1';">Liste des responsables</h3>
                        </div>
                                        ...
                                        <tbody>
                                            <?php foreach($msgs as $msg):?>
                                                <tr>
                                                    ...
                                                    <td><center><a href="mailto: <?=$msg['login'] ?>" ><i class="glyphicon glyphicon-pencil"></i></a></center></td>
                                                </tr>
                                            <?php endforeach ;?> 
                                        </tbody>
                                    </table>
