...
<nav class="navbar navbar-default navbar-static-top">
                           ...
                           <nav class="navbar navbar-default" role="navigation"">
                              ...
                              <div class="side-menu-container" >
                                 <ul class="nav navbar-nav">
                                       <!-- ajouter 1 -->
                                       <li><a href="page_admin.php"><span><i class="glyphicon glyphicon-cog"></i></span> Gestion des responsables</a></li>
                                       <li class="active"><a href="gest_local.php"><span><i class="glyphicon glyphicon-cog"></i></span> Gestion des localisations</a></li>
    ...
    <div class="col-md-10 content" >
        <div class="panel panel-default" style="background-color: rgba(255, 255, 255, .3); width:40% ; margin-right:8%" >
            ...
            <p style="font-size:20px; font-family:'Gothic A1';"> Gestion des Localisations</p>
            </div>
            <div class="panel-body" style="height : 250px;">
                <div class="row">  
                <br><br>          
                    <div class=" col-md-offset-1 col-md-4">
                        <a id="ch1" href="ajout_local.php"><button type="submit" class="btn btn-lg btn-primary btn-blocks col-md-12">
                        <span><i class="glyphicon glyphicon-plus"></i></span>Ajouter une localisation</button> </a>
                    </div>
                     <div class="col-md-offset-1 col-md-4">
                        <a id="ch1" href="supp_local.php"><button type="submit" class="btn btn-lg btn-primary btn-blocks col-md-12">
                        <span><i class="glyphicon glyphicon-trash"></i></span>Supprimer une localisation</button></a>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-offset-1 col-md-4">
                        <a id="ch1" href="liste_local.php"><button type="submit" class="btn btn-lg btn-primary btn-blocks col-md-12">
                        <span><i class="glyphicon glyphicon-list-alt"></i></span>Liste des localisations</button></a>
                    </div>
                </div>
            </div>
        </div>
