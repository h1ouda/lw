...
?>
 <?php 
       $pdostat=$base->prepare("SELECT id, description ,url,localisation FROM ressource where responsable= '".$_SESSION['login']."'");
       //execution requete
            ...
            <div class="col-md-2 sidebar">
                           ...
                           <nav class="navbar navbar-default" role="navigation" >
                              ...
                              <div class="side-menu-container">
                                 ...
                                 <ul class="nav navbar-nav">
									   ...
									   <li><a href="page_resp.php"><span><i class="glyphicon glyphicon-cog"></i></span> Liste des anomalies</a></li>
                ...
                <div class="col-md-10 content">
                    <div class="panel panel-default" style="background-color: rgba(255, 255, 255, .3) ; width:40% ; margin-right:8%"> <!--couleur de la liste des problémes-->
                            ...
                            <h3 style="font-size:20px; font-family:'Gothic A1';">Listes des ressources </h3>
                        </div>
                                        ...
                                        <tbody>
                                            <?php foreach($msgs as $msg):?>
                                                <tr>
												   ...
												   <td><form  action="list_ress.php" method="GET" >
...
if(isset($_GET['supprimer'])){
   ...
   $press = $base->prepare("DELETE FROM `ressource` WHERE id='".$msg['id']."'  ");
   ...
   if ($press){
    ...
    alert ("La ressource a été supprimée avec succès !" )
		  ...
		  echo '<script>location = "list_ress.php"</script>';}
         else{
            echo '<script language="Javascript">
