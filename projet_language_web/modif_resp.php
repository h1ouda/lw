...
if(isset($_POST['modifier'])){
    ...
    $role=$_POST['role'];
        ...
        $pres = $base->prepare("UPDATE utilisateur SET role='$role'  WHERE   login='$login' ");
          //execution de la requete
         $pres->execute();
        $result=$pres;
        if(!$result){
            echo '<script language="Javascript">
        alert ("les modification non pas été apporter !" )
             </script>';}
             else{
                echo '<script language="Javascript">
    ...
    <div class="container-fluid main-container" style="background : linear-gradient(45deg, #FC466B, #3F5EFB)">
       ...
       <div class="col-md-10 content" >
        <div class="panel panel-default" style="background-color: rgba(255, 255, 255, .3); width:40% ; margin-right:8%">
                 ...
                 <p style="font-size:20px; font-family:'Gothic A1';"> Modification d'un responsable</p>
                </div>
                    ...
                    <div class="col-md-6 col-md-offset-3">
                            <form class="well form-horizontal" action="" method="post"  >
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label class=" control-label" for="eail">login du responsable</label>
                                        <input id="login" name="login" type="text" placeholder="saisir le login" class="form-control" required>  
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label class=" control-label" for="mot_de_passe">nouveau role du responsable</label>
                                        <input id="role" name="role" placeholder="saisir le nouveau role" type="text" class="form-control" >  
                                    </div>
                                </div>
                                
                                <div class="form-group">
                                    <div class=" col-md-12">
                                        <input type="submit" value="Modifier" id="singlebutton" name="modifier" class="btn btn-primary btn-lg">
                                    </div>
                                </div>
                        </form> 
                        </div>
