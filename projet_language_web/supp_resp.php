...
if(isset($_POST['supprimer'])){
   ...
   $press = $base->prepare("DELETE FROM `utilisateur` WHERE login='$login'  ");
   //execution de la requete
   $executepress = $press->execute();
   if ($press){
    echo '<script language="Javascript">
    alert ("Le résponsable a été supprimée avec succès !" )
         </script>';}
         else{
            echo '<script language="Javascript">
    ...
    <div class="container-fluid main-container" style="background : linear-gradient(45deg, #FC466B, #3F5EFB)">
       ...
       <div class="col-md-10 content" >
        <div class="panel panel-default" style="background-color: rgba(255, 255, 255, .3); width:40% ; margin-right:8%">
                 ...
                 <p style="font-size:20px; font-family:'Gothic A1';">Suppression d'un responsable</p>
                </div>
                    ...
                    <div class="col-md-6 col-md-offset-3">
                            <form class="well form-horizontal" action="" method="post"  >
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label class=" control-label" for="id">login du responsable</label>
                                        <input id="login" name="login" type="text" placeholder="saisir le login du responsable" class="form-control" required>  
                                    </div>
                                </div>
                                
                                <div class="form-group">
                                    <div class=" col-md-12">
                                        <input type="submit" value="Supprimer le responsable" id="singlebutton" name="supprimer" class="btn btn-primary btn-lg">
                                    </div>
                                </div>
                        </form> 
                        </div>
